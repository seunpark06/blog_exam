...
class BlogApiControllerTest {
    ...
    @Autowired
    protected ObjectMapper objectMapper; //자바객체 <-> JSON 데이터 변환
   ...
   @Autowired
    ...
    @DisplayName("addArticle: 블로그 글 추가에 성공함")
    @Test
    ...
    @DisplayName("findAtricle: 블로그 글 조회에 성공함")
    @Test
    public void findAtricle() throws Exception {
        //given
